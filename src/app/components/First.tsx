...
function First() {
  function handleMouseOver() {
    ...
    text.innerHTML = "Front End Developer.";  }
  function handleMouseLeave() {
    const text : any = document.getElementById("text")
    
    text.innerHTML = "Software Engineer.";
  }
  return (
    <div className="first">
      ...
      <div className="typewriter">
        <h4 id="text" onMouseOver={handleMouseOver} onMouseLeave={handleMouseLeave}>Software Engineer.</h4>
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <a>
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                {" "}
                <title>instagram [#fffffffffff]</title>{" "}
