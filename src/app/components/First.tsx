...
function First() {
  function handleMouseOver() {
    ...
    text.innerHTML = "Typescript Developer.";  }
  function handleMouseLeave() {
    const text : any = document.getElementById("text")
    
    text.innerHTML = "FullStack Developer.";
  }
  return (
    <div className="first">
      ...
      <div className="typewriter">
        <h4 id="text" onMouseOver={handleMouseOver} onMouseLeave={handleMouseLeave}>FullStack Developer.</h4>
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          <Link href='https://github.com/Momessito'>
            <svg
              viewBox="0 0 20 20"
              version="1.1"
